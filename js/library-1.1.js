...
const render_images = (c) => {
    ...
    const car_p = document.getElementsByClassName('carousel');
    const car_w = car_p[0].clientWidth;
    
    car_p[0].style.minHeight = car_w*0.5617+'px';
    car_p[0].style.Height = car_w*0.5617+'px';
    car_p[0].style.maxHeight = car_w*0.5617+'px';
}
